...
public class MainActivity extends Activity {
     ...
     */
    public static final String MIXPANEL_API_TOKEN = "c0d635ef148040054c01f10775fa2004";
     ...
     */
    public static final String ANDROID_PUSH_SENDER_ID = "69625964474";

    public static final String TAG = "CLUBSIM";

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
//        final String trackingDistinctId = getTrackingDistinctId();
        final String trackingDistinctId = "321";
        ...
        mMixpanel.getPeople().initPushHandling(ANDROID_PUSH_SENDER_ID); // forget about the previous minute, this is where I setup push notification
        // now I'm closing the app on my phone and try this again
